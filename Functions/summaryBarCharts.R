#' Create bar charts summarizing data by river segment.
#' 
#' @description Creates bar charts summarizing water quality indicators for aquatic life , recreation, human health, and agriculture.  
#' 
#' @param segment String variable of the desired river segment.
#' @param Data Data frame containing water quality output data generated by the summaryCalcs function.
#' 
#' @return Bar chart in PNG format.
#' 
#' @usage summaryBarCharts(segment, Data)
#' 
#' @export

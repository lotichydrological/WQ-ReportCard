#' Evaluate annual median sample data
#' 
#' @description Evaluate annual median sample data from water quality data frame. If more than one sample exists, a rolling mean of sample values is calculated.  
...
#' 
#' @usage annual_median_eval(Data, standard) 
#' 
#' @export 

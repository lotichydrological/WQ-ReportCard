...
plotDischarge_validate = function(segmentName, wqData){
  segInfo = dischargeStations[dischargeStations$SegmentID == segmentName,]
  ...
  filename <- paste(c("./Figures/qPlots/",segmentName,"_Q_plot.png"),collapse="")

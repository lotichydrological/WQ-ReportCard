maxDate_validate = function(characteristicNames, Units, valueType, Maximum){
  ...
  Data <- standardize_units_validate(Data) # 
  ...
  dateOfMax = as.character(dataSet[match(Maximum, dataSet$ResultMeasureValue),2])
  return(dateOfMax)
}
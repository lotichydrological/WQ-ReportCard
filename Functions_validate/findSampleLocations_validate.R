...
countSamples_validate = function(monitoringStation, Data){
...
findSampleLocations_validate = function(segmentName, Data){
  uniqueStations = unique(as.list(Data$MonitoringLocationIdentifier))
  stationList <- do.call(rbind, lapply(uniqueStations, countSamples_validate, Data))

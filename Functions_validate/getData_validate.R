getData_validate = function(segmentName, StartDate, EndDate){ #retrieve segment data from the Water Quality Portal
  Stations = groupStations_validate(segmentName)
